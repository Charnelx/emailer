...
class Emailer(object):
    ...
    def __init__(self, usr, pwd, server='smtp.gmail.com', port=587, hide=True):
        self.user = usr
        self.password = pwd
        self.server = server
        self.port = port
        ...
        self.pattern_img = r'(<REPLACE_IMG>.+</REPLACE_IMG>)'

    def attach_image(self, img_dict: dict):
        """
    ...
    def prepare_email(self, subject: str, recipients: list, content: str, images=None):
        """
        ...
        if images:
            ...
            for image in images:
                ...
                content = re.sub(self.pattern_img, img_html, content)
    ...
    def send_email(self, subject: str, content_path: str, recipients: list):
        """
